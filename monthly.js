...
async function getTrendingRepos() {
  ...
  try {
    ...
    await page.goto("https://github.com/trending?since=monthly", {
...
async function sendToWechat(text) {
  try {
    ...
    const data = {
      msgtype: "markdown",
      markdown: {
        content: `# 🌟 GitHub 本月热门项目 (${formattedDate})

${text}

> 数据来源: [GitHub Trending](https://github.com/trending?since=monthly)

[daily](https://github.com/trending?since=daily) | [weekly](https://github.com/trending?since=weekly)`,
      },
    };
